...
class ReportController extends Controller
{
    ...
    {
        $coursePurchases = CoursePurchase::searchable(['user:username', 'course:title'])->with('user', 'course');
        ...
        $pageTitle = 'Purchased History | ' . gs('cur_sym') . showAmount($purchasedAmount);
