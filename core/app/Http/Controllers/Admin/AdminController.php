...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $recentCourseSold = Course::premium()->with('coursePurchases')->orderBy('id', 'desc')->limit(20)->get();

        $recentCourseSold = $recentCourseSold->mapWithKeys(function ($course) {
            return [
                $course->title => $course->coursePurchases->sum('purchased_amount'),
            ];
        })->toArray();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'sold', 'chart', 'deposit', 'depositsMonth', 'months', 'trxReport', 'recentCourseSold'));
    }
