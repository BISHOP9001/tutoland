            ...
            $('.addFile').on('click', function() {
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <button type="button" class="input-group-text btn--danger text-white remove-btn border-0"><i class="las la-times"></i></button>
                    </div>
                `)
            });
...
@push('breadcrumb-buttons')
    <div class="button-list">
        <li class="button-list__item">
            <a href="{{ route('ticket.index') }}" class="btn btn--base flex-align btn--sm"> <span class="icon"><i class="las la-list"></i></span>@lang('My Tickets')</a>
        </li>
    </div>
@endpush
