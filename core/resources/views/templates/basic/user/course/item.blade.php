    ...
    <div class="course__content">
        <div class="course__title">
            ...
            <div class="flex-align">  
                ...
                <span class="course__ratting number ms-1"> {{ showAmount($course->avg_rating, 1) }} ({{ $course->total_review }})</span>
            </div>
        </div>
        <div class="course__details">
            ...
            <div class="feature-list">
                <div class="inner-list">
                    ...
                    <span class="feature-list__value course__price">{{ $general->cur_sym }}{{ showAmount($myCourse->purchased_amount) }}</span>
                </div>
