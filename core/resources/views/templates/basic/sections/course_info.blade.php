            ...
            <div class="col-md-6">
                <div class="live-course-info-content">
                    ...
                    <a class="live-course-info-lightbox" href="{{ $courseInfo->data_values->video_link }}">
                        <img src="{{ getImage('assets/images/frontend/course_info/'.$courseInfo->data_values->video_thumb,'500x330') }}" alt="Live Course Info Lightbox Thumb">
                    </a>
                </div>
            </div>
                ...
                <ul class="live-course-info-keypoints">
                    ...
                    <li class="live-course-info-keypoints-item">
                        <div class="live-course-info-keypoints-icon">
                            <img src="{{ getImage('assets/images/frontend/course_info/'.@$courseInfo->data_values->image,'50x50') }}" alt="@lang('Course Info')">
                        </div>
