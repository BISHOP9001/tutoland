        ...
        <div class="custom--container">
            <div class="row g-4">
                    ...
                    <div class="banner-inner">
                        ...
                        <div class="banner-info">
                            <div class="banner-info-student-images">
                                <img src="{{ getImage('assets/images/frontend/banner/' . @$banner->data_values->students_image, '150x45') }}" alt="@lang('Student')">
                            </div>
                ...
                <div class="col-lg-5 col-xl-5 position-relative d-none d-lg-flex flex-column justify-content-center align-items-start">
                    <img class="banner-img" src="{{ getImage('assets/images/frontend/banner/' . @$banner->data_values->banner_image, '510x510') }}" alt="Banner Image">

                    <div class="banner-floating-cards">
                        <div class="floating-card">
                            <div class="floating-card-icon">
                                <img src="{{ getImage('assets/images/frontend/banner/' . @$banner->data_values->first_course_image, '40x40') }}" alt="Close Tag">
                            </div>
                        ...
                        <div class="floating-card">
                            <div class="floating-card-icon">
                                <img src="{{ getImage('assets/images/frontend/banner/' . @$banner->data_values->second_course_image, '40x40') }}" alt="Close Tag">
                            </div>
                            <div class="floating-card-content">
