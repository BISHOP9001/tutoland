<div class="sidebar-menu">
    <div class="sidebar-menu__inner">
        ...
        <div class="sidebar-logo">
            <a href="{{ route('home') }}" class="sidebar-logo__link"><img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" alt=""></a>
        </div>
        <!-- Sidebar Logo End -->
        ...
        <ul class="sidebar-menu-list">
            ...
            <li class="sidebar-menu-list__item {{ menuActive('user.certifications') }}">
                <a href="{{ route('user.certifications') }}" class="sidebar-menu-list__link">
                    <span class="icon"><i class="las la-passport"></i></span>
                    <span class="text">@lang('My certifications')</span>
                </a>
            </li>
        </ul>
        <!-- ========= Sidebar Menu End ================ -->
