                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-lg" type="text" name="ftp[domain]" value="{{@$general->ftp->domain}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-lg" type="text" name="ftp[host]" value="{{@$general->ftp->host}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Username')</label>
                                    <input class="form-control form-control-lg" type="text" name="ftp[username]" value="{{@$general->ftp->username}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Password')</label>
                                    <input class="form-control form-control-lg" type="text" name="ftp[password]" value="{{@$general->ftp->password}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Port')</label>
                                    <input class="form-control form-control-lg" type="text" name="ftp[port]" value="{{@$general->ftp->port}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Root Folder')</label>
                                    <input class="form-control form-control-lg" type="text" name="ftp[root]" value="{{@$general->ftp->root}}">
                                </div>
                            </div>
                        </div>
