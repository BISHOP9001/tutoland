                ...
                <div class="card-body">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                @if ($lesson->server == 2)
                                    <iframe width="100%" height="400px" src="{{ convertToEmbedUrl($lesson->path) }}" frameborder="0" allowfullscreen></iframe>
                                @else
                                    <video controls preload="auto" width="100%" poster="{{ getImage(getFilePath('video_thumb') . '/' . $lesson->thumb_image, getFileSize('video_thumb')) }}" id="myVideo">
                            ...
                            <div class="col-lg-6">
                                <form enctype="multipart/form-data" id="videoForm">
                                    ...
                                    <div class="form-group youtubeGroup">
                                        ...
                                        <input type="text" name="youtube_link" @if ($lesson->server == 2) value="{{ $lesson->path }}" @endif class="form-control">
                                    </div>
                                    <div class="form-group youtubeGroup">
                                        <label>@lang('Duration') @lang('HH:MM:SS')</label>
                                        <input type="text" name="duration" value="{{ now()->startOfDay()->addSeconds($lesson->video_duration)->format('H:i:s') }}" placeholder="@lang('02:17:45')" class="form-control">
                                    </div>
                                    <div class="mt-4">
                                        <button type="submit" id="uploadBtn" class="btn btn--primary w-100 h-45">@lang('Upload')</button>
                                    </div>
                                </form>
                            </div>
                        </div>
