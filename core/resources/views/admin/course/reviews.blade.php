                                ...
                                @forelse ($reviews as $review)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span class="small">
                                                <a href="{{ route('admin.users.detail', $review->user->id) }}"><span>@</span>{{ $review->user->username }}</a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--primary reviewBtn" data-review="{{ __($review->review) }}">
                                                    <i class="la la-eye"></i>@lang('Review')
                                                </button>                                               
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn" data-question="@lang('Are sure to delete this review?')" data-action="{{ route('admin.course.review.delete', $review->id) }}">
