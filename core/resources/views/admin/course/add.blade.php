                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="form-control" required>
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}" @selected(old('category_id') == $category->id)>{{ __($category->name) }} @if (!$category->status)
                                                                (@lang('Inactive'))
                                                            @endif
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="premium" class="form-control">
                                                    ...
                                                    <option @selected(request()->has('free')) value="0">@lang('No')</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 priceArea">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" min="0" class="form-control" name="price" value="{{ old('price') }}">
                                        ...
                                        <div class="col-md-6 priceArea">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" min="0" class="form-control" name="discount_price" value="{{ old('discount_price') }}">
                                                    <span class="input-group-text">{{ __($general->cur_text) }}</span>
                                                </div>
                                            </div>
                                        </div>
