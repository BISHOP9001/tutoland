                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn" data-section="{{ $section }}">
                                                    <i class="la la-pencil"></i>@lang('Edit')
                                                </button>
                                                <a href="{{ route('admin.course.section.lessons', $section->id) }}" class="btn btn-sm btn-outline--info" data-section="{{ $section }}">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group statusBadge">
                            ...
                            <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="status">
                        </div>
                    </div>
