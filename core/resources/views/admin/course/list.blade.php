                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($course->discount_price > 0)
                                                <del>{{ $general->cur_sym }}{{ showAmount($course->price) }}</del>
                                            ...
                                            <div class="button--group">
                                                ...
                                                <div class="dropdown-menu more-dropdown">
                                                    @if ($course->status == Status::DISABLE)
                                                        <button class="dropdown-item confirmationBtn" data-action="{{ route('admin.course.status', $course->id) }}" data-question="@lang('Are you sure to enable this course?')">
                                                            <i class="la la-eye"></i> @lang('Enable')
                                                        </button>
                                                    @else
                                                        <button class="dropdown-item confirmationBtn" data-action="{{ route('admin.course.status', $course->id) }}" data-question="@lang('Are you sure to disable this course?')">
                                                            <i class="la la-eye-slash"></i> @lang('Disable')
                                                        </button>
                                                    @endif

                                                    <a href="{{ route('admin.course.section', $course->id) }}" class="dropdown-item">
                                                        <i class="las la-layer-group"></i> @lang('Sections')
                                                    </a>
                                                    <a href="{{ route('admin.course.lessons', $course->id) }}" class="dropdown-item">
                                                        <i class="las la-video"></i> @lang('Lessons')
                                                    </a>
                                                    <a href="{{ route('admin.course.quiz', $course->id) }}" class="dropdown-item">
                                                        <i class="las la-video"></i> @lang('Quiz')
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
