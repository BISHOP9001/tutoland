                            ...
                            <tbody>
                                @forelse ($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td>{{ $general->cur_sym }}{{ showAmount($coupon->minimum_spend) }}</td>
                                        <td>{{ $general->cur_sym }}{{ showAmount($coupon->maximum_spend) }}</td>
                                        <td>{{ $coupon->code }}</td>
                                        <td>{{ $general->cur_sym }}{{ showAmount($coupon->discount_amount) }} {{ $coupon->discount_type ? '%' : ' ' . __($general->cur_text) }}</td>
                                        <td> @php echo $coupon->statusBadge; @endphp </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn" data-coupon="{{ $coupon }}" data-amount="{{ getAmount($coupon->discount_amount) }}" data-min_spend="{{ getAmount($coupon->minimum_spend) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="minimum_spend" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="maximum_spend" class="form-control" required>
                                        <span class="input-group-text">{{ __($general->cur_text) }}</span>
                                    </div>
                                </div>
                            </div>
