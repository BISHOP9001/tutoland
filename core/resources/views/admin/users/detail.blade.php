            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $purchasedCourses }}</h3>
                            <p class="text-white">@lang('Purchased Courses')</p>
                        </div>
                        <a href="{{ route('admin.report.purchase.history') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white">@lang('Total Reviews')</p>
                            <a href="{{ route('admin.course.reviews') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                        </div>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $supportTickets }}</h3>
                            <p class="text-white">@lang('Support Tickets')</p>
                        </div>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
